export const aboutMeContent = {
    description: [
        ...
        `Após um ano nesse modelo, percebi que era necessário fazer uma pausa no meu trabalho, que no momento era de garçom, para focar em me desenvolver profissionalmente. Desde então, tenho estudado programação full-stack na <a href="https://www.betrybe.com/" target="_blank">Trybe</a>.`,
    ],
    ...
    alt: 'Foto de um monitor mostrando códigos de programação',
