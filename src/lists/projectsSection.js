export const sectionContent = [
    {
        name: 'To-Do List',
        urlGitHub: 'https://github.com/Buenno01/todo-list',
    ...
    {
        name: 'Weather',
        urlGitHub: 'https://github.com/Buenno01/weather',
    ...
    {
        name: 'Calculator',
        urlGitHub: 'https://github.com/Buenno01/Calculator',
    ...
    {
        name: 'pixel-editor',
        urlGitHub: 'https://github.com/Buenno01/pixel-editor',
